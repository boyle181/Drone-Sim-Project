#ifndef LIBS_TRANSIT_INCLUDE_DATACOLLECTIONSINGLETON_H_
#define LIBS_TRANSIT_INCLUDE_DATACOLLECTIONSINGLETON_H_
...
/**
 * @brief This is the data collection class. It is able to accumlate data
 * related to drones and robots in the simulation such as time, distance
 * traveled, account information, battery usage (Only Drones), and number of
 * trips (Only Drones). It outputs the CSV file on command.
 */
class DataCollectionSingleton {
 public:
   ...
   */
  DataCollectionSingleton(const DataCollectionSingleton& other) = delete;
...
#endif  // LIBS_TRANSIT_INCLUDE_DATACOLLECTIONSINGLETON_H_
